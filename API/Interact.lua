...
Layout.draw = function(self,xPlus,yPlus)
	...
	for i,v in pairs(self.ColorField) do
		colorFieldFunctions.draw(v,self.xPos-1,self.yPos-1,xPlus,yPlus)
	end
	for i,v in pairs(self.Button) do
		buttonFunctions.draw(v,self.xPos-1,self.yPos-1,xPlus,yPlus)
	end
	for i,v in pairs(self.BetterPaint) do
		betterPaintFunctions.draw(v,self.xPos-1,self.yPos-1,xPlus,yPlus)
	end
	for i,v in pairs(self.Toggle) do
		toggleFunctions.draw(v,self.xPos-1,self.yPos-1,xPlus,yPlus)
	end
	for i,v in pairs(self.Text) do
		textFunctions.draw(v,self.xPos-1,self.yPos-1,xPlus,yPlus)
	end
	for i,v in pairs(self.TextBox) do
		textBoxFunctions.draw(v,self.xPos-1,self.yPos-1,xPlus,yPlus)
	end
